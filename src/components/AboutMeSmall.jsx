  ...
  return (
    ...
    >
      <div className="flex justify-center items-end md:items-center md:justify-start p-1">
        <img
          src={pic}
          className="block dark:hidden md:w-48 md:h-64 w-40 h-10 rounded-xl"
        />
        <img
          src={pic}
          className="hidden dark:block md:w-48 md:h-64 w-40 h-10 rounded-xl"
        />
      </div>
      <div className="p-5 md:w-full">
        <div className="text-lg leading-9  text-white">
          <span>
            Hey there, welcome to my portfolio website! Below, I have a timeline
            of my Software Engineering journey. On this site, I also highlight
            my experience, skills, and projects - enjoy!{" "}
          </span>
        </div>
      </div>
    </motion.div>
