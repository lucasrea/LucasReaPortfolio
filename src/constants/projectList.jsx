...
import { SiJavascript, SiNodedotjs, SiNumpy, SiOpencv, SiPandas, SiPytorch, SiScikitlearn, SiTensorflow } from "react-icons/si";
...
export const projects = [
  ...
  },
  {
    ...
    githubURL: "https://github.com/eanile/APS360_Project",
    techStack: [
      {name: "Python", icon: <FaPython className="text-xl" />},
      {name: "Numpy", icon: <SiNumpy className="text-xl" />},
  ...
  },
  {
    ...
    articleURL: "https://medium.com/@lucas.rea1998/python-neural-networks-from-scratch-e302e7a200a1",
    techStack: [
      {name: "Python", icon: <FaPython className="text-xl" />},
      {name: "Numpy", icon: <SiNumpy className="text-xl" />},
    ],
  },
  {
    ...
    articleURL: "https://towardsdatascience.com/predicting-future-stock-market-trends-with-python-machine-learning-2bf3f1633b3c",
    techStack: [
      {name: "Python", icon: <FaPython className="text-xl" />},
      {name: "Numpy", icon: <SiNumpy className="text-xl" />},
      {name: "Pandas", icon: <SiPandas className="text-xl" />},
